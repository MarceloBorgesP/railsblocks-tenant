module Railsblocks::Tenant
  class Engine < ::Rails::Engine
    isolate_namespace Railsblocks::Tenant
    ...
    initializer "railsblocks-tenant.factories", :after => "factory_girl.set_factory_paths" do
      FactoryGirl.definition_file_paths << File.expand_path('../../../../spec/factories', __FILE__) if defined?(FactoryGirl)
    end


    # Initialize engine dependencies on wrapper application
    Gem.loaded_specs["railsblocks-tenant"].dependencies.each do |d|
      begin
        require d.name
      rescue LoadError => le
        # Put exceptions here.
